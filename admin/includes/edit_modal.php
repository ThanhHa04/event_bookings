          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="text-center mb-2">
                <label class="form-label">Ảnh sự kiện (upload)</label>
                <img id="eventImagePreview" src="" alt="Ảnh sự kiện" class="img-fluid rounded shadow mb-2" style="max-height: 200px;">
