<?php
session_start();
require_once "../config.php";  // Đảm bảo có file config chứa thông tin DB
require_once "../includes/db_connect.php";  // Đảm bảo có file db_connect để kết nối
...
$stmt = $pdo->prepare("SELECT * FROM music_events WHERE id = ?");
...
<div class="container mt-3 mb-3">
    <div class="event-image mb-4 text-center">
        <img src="<?php echo htmlspecialchars($event['image']); ?>" class="img-fluid rounded" alt="Event Image">
    </div>
